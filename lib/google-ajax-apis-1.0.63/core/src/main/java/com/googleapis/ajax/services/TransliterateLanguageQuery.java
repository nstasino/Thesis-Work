 ...
 */
public interface TransliterateLanguageQuery extends GoogleSearchQuery<TransliterateLanguageResult> {
	 ...
	 */
	public TransliterateLanguageQuery withLanguagePair(Language sourceLanguage, Language targetLanguage);
