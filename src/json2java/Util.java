...
//            out.append(header3);
    ...
    /**
     * Certain tweaks (special character removals etc) are needed before feeding the file to WEKA
     *
     * @see Attribute-Relation File Format ARFF Description --> http://www.cs.waikato.ac.nz/~ml/weka/arff.html
...
//                                newContents = newContents.replaceAll("\\\\", "*");
    ...
    /**
     * Created initially to remove new line characters, does some dirty work when it comes to the getters of Ticket class objects
     *
     * @see json2java.Ticket
     * @see Attribute-Relation File Format ARFF Description  http://www.cs.waikato.ac.nz/~ml/weka/arff.html
     * @param str
     * @return the same
     */
